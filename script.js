...
if (contactForm) {
  ...
  contactForm.addEventListener('submit', async (event) => {
    ...
    // Si el endpoint todavía no fue configurado (ver comentario en index.html),
    // avisamos en vez de intentar un envío que va a fallar.
    const endpoint = contactForm.getAttribute('action') || '';
    const isConfigured = endpoint.length > 0 && !endpoint.includes('REPLACE_WITH_YOUR_FORM_ID');
